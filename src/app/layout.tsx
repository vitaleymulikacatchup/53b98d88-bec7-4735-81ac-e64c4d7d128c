...
export const metadata: Metadata = {
  title: "Be Better IT School - Programming & Tech Courses",
  description: "Transform your tech career with expert-led IT courses. Learn from industry professionals. 94% job placement rate. Enroll today.",
  keywords: "IT courses, programming, coding bootcamp, full-stack development, data science, cloud computing",
  metadataBase: new URL("https://bebetter-it.school"),
  alternates: {
    canonical: "https://bebetter-it.school"
  },
  openGraph: {
    title: "Be Better IT School - Programming & Tech Courses",
    description: "Master in-demand tech skills with expert instructors. Career support included.",
    type: "website",
    siteName: "Be Better IT School"
  },
  twitter: {
    card: "summary_large_image",
    title: "Be Better IT School",
    description: "Transform your tech career with expert-led IT courses"
  },
  robots: {
    index: true,
    follow: true
